...
###############################################################################
def basic_hillshade_snakemake():
    """
    Shallow call for snakemake to process a basic hillshade for a DEM.
...
###############################################################################
def pretty_hillshade_snakemake():
    """
    Shallow call for snakemake to process a pretty hillshade for a DEM.
